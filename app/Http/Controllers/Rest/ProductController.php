...
class ProductController extends LinkedMachineController
{
     ...
     *             @OA\Property(property="product_promo_image", type="string", default="product_promo_image"),
     *             @OA\Property(property="product_more_image1", type="string", default="product_more_image1"),
     *             @OA\Property(property="product_more_image2", type="string", default="product_more_image2"),
     *             @OA\Property(property="product_more_image3", type="string", default="product_more_image3"),
     *             @OA\Property(property="product_more_image4", type="string", default="product_more_image4"),
