...
const Customer = ({ navigation }) => {
    ...
    return (
        <SafeAreaView>
            ...
            <CurrentMachineHeader showDrawerIcon={false} text={"Customer Reports"} />
        ...
        />
                            ...
                            <View style={[appStyles.rowSpaceBetweenAlignCenter, { alignSelf: "flex-end" }]}>
                                ...
                                <ExportWrapper text={"Schedule Customer Reports "} Icon={Calender} />
                        ...
                        <View style={[feedbackStyles.feedbackListMainContainer]}>
                            <CollapsibleList filtersBy={selectedValue} querykey={"CUSTOMERREPORT"} fn={getMobileCustomerReport}
                                keyOfArrayOrFunctions={"CUSTOMERARRAY"}
