        ...
        {categoriesList && (
          ...
          >
            <SwiperSlide key={"All Categories"}>
              <div className={`w--full border-full--black-100 bg--${!selectedCategory ? "orange-200" : "white"} radius--sm h-min--60 gap--md p--sm d--flex align-items--center justify-content--start p-l--sm c--pointer`} onClick={() => setSelectedCategory("")}>
            ...
            {categoriesList &&
              ...
              categoriesList?.data.map((category, index) => (
                <SwiperSlide key={index + 1}>
                  <div className={`w--full border-full--black-100 bg--${selectedCategory == category.category_id ? "orange-200" : "white"} radius--sm h-min--60 gap--md p--sm d--flex align-items--center justify-content--start p-l--sm c--pointer`} onClick={() => setSelectedCategory(category.category_id)}>
        ...
        {allProductList?.data.map((product, index) => (
          <div className="bg--white radius--sm d--flex gap--md w--full p--md" key={index}>
            ...
            <div className="d--flex gap--sm w--full">
              <div className="w--full d--flex flex--column gap--sm p-l--lg border-left--black-100">
                <div className="w--full d--flex gap--sm flex--column">
                  <div className="font--md text--red font--600 product-name"  onClick={() => navigate(`${PRODUCT_CONST.EDIT_PRODUCT}/${DETAIL_TABS_CONST.PRODUCT_DETAILS}`, { state: { uuid: product.uuid } })}>
                    {product.product_name}
                  </div>
                </div>
                <div className="d--flex w--full">
                  <div className="w--full d--flex gap--sm flex--column">
                    ...
                    <div className="font--sm  font--600">A$ {product.product_price}</div>
                    <div className=" d--flex align-items--end justify-content--end gap--sm ">
                <Button variant="black-50" color="black-800" btnClasses="btn btn--xs w-max--100 w-min--50" onClick={() => navigate(`${PRODUCT_CONST.EDIT_PRODUCT}/${DETAIL_TABS_CONST.PRODUCT_DETAILS}`, { state: { uuid: product.uuid } })}>
                  <EditIcon width={16} />
                </Button>
                <Button variant="red-100" color="red" btnClasses="btn btn--xs w-max--100 w-min--50 " onClick={() => handleShowDeleteModal(product)}>
                  <TrashIcon width={16} />
                </Button>
              </div>
                  </div>
