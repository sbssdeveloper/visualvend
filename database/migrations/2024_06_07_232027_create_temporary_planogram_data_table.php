...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('temporary_planogram_data', function (Blueprint $table) {
            $table->integer('id', true);
            $table->string('plano_uuid', 36);
            ...
            $table->string('product_location', 64);
    ...
    {
        Schema::dropIfExists('temporary_planogram_data');
    }
};
